...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-6 w-7 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-0"
      )} />
  </SwitchPrimitives.Root>
))
